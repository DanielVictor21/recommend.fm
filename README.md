...
<div class="highlight highlight-source-shell notranslate position-relative overflow-auto" dir="auto"><pre>pip install requirements.txt <span class="pl-smi">(librarys)</span></pre><div class="zeroclipboard-container">
